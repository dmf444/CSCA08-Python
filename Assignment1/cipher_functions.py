...
def triple_cut(card_list):
    ...
    >>> list1 = [1, 4, 7, 10, 13, 16, 19, 22, 25, 23, 3, 6, 28, 27, 9, 12, 15, 18, 21, 24, 2, 5, 8, 11, 14, 17, 20, 26]
    >>> triple_cut(list1)
    >>> print(list1)
...
def insert_top_to_bottom(card_list):
    ''' (list of integers) -> NoneType
    This function takes the last number in the card_list, takes all number from 0 to that index. It will then take that
    spliced value and move it from the top of the list to the bottom, just before the last value.
    REQ: card_list must be a list of integers, cannot be empty
    >>> list1 = [1, 4, 7, 10, 13, 16, 19, 22, 25, 23, 3, 6, 28, 27, 9, 12, 15, 18, 21, 24, 2, 5, 8, 11, 14, 17, 20, 26]
    >>> insert_top_to_bottom(list1)
    >>> print(list1)
    [20, 1, 4, 7, 10, 13, 16, 19, 22, 25, 23, 3, 6, 28, 27, 9, 12, 15, 18, 21, 24, 2, 5, 8, 11, 14, 17, 26]
    >>> list2 = [1, 4, 7, 10, 13, 16, 19, 22, 25, 23, 3, 6, 26, 27, 9, 12, 15, 18, 21, 24, 2, 5, 8, 11, 14, 17, 20, 28]
    >>> insert_top_to_bottom(list2)
    >>> print(list2)
    [1, 4, 7, 10, 13, 16, 19, 22, 25, 23, 3, 6, 26, 27, 9, 12, 15, 18, 21, 24, 2, 5, 8, 11, 14, 17, 20, 28]
    >>> list3 = [1, 4, 7, 10, 13, 16, 19, 22, 25, 23, 3, 28, 26, 27, 9, 12, 15, 18, 21, 24, 2, 5, 8, 11, 14, 17, 20, 6]
    >>> insert_top_to_bottom(list3)
    >>> print(list3)
    [19, 22, 25, 23, 3, 28, 26, 27, 9, 12, 15, 18, 21, 24, 2, 5, 8, 11, 14, 17, 20, 1, 4, 7, 10, 13, 16, 6]
    '''
    ...
    true_int = last_int
    # If the final number is JOKER2, switch to JOKER1, make the duplicate variable JOKER2
    if(last_int == JOKER2):
        last_int = JOKER1
        true_int = JOKER2
    ...
    # Create a new list from the previous splice, starting with the numbers after the splice.
...
def get_card_at_top_index(card_list):
    ...
    This function looks at the first value in the card_list and returns the number at that index. If the first card is
    equal to JOKER2, then the value of JOKER1 is used.
    REQ: card_list must be a list of integers, cannot be empty
    >>> list1 = [1, 4, 7, 10, 13, 16, 19, 22, 25, 23, 3, 6, 28, 27, 9, 12, 15, 18, 21, 24, 2, 5, 8, 11, 14, 17, 20, 26]
    >>> print(get_card_at_top_index(list1))
    4
    >>> list2 = [28, 4, 7, 10, 13, 16, 19, 22, 25, 23, 3, 6, 1, 27, 9, 12, 15, 18, 21, 24, 2, 5, 8, 11, 14, 17, 20, 26]
...
def get_next_value(card_list):
    ''' (list of integers) -> int
    This function runs through all steps of the encryption algorithm and outputs a keystream value.
    REQ: card_list must be a list of integers, card_list cannot be empty
    >>> list1 = [1, 4, 7, 10, 13, 16, 19, 22, 25, 23, 3, 6, 28, 27, 9, 12, 15, 18, 21, 24, 2, 5, 8, 11, 14, 17, 20, 26]
    >>> print(get_next_value(list1))
    27
    >>> list2 = [1, 4, 7, 10, 13, 16, 19, 22, 28, 23, 3, 6, 25, 27, 9, 12, 15, 18, 21, 24, 2, 5, 8, 11, 14, 17, 20, 26]
...
def get_next_keystream_value(card_list):
    """ (list of integers) -> int
    This function will run the encryption algorithm until a valid keystream is found (number from 1-26). Returns that
    new value.
    REQ: card_list must be a list of integers, card_list cannot be empty
    >>> list1 = [1, 4, 7, 10, 13, 16, 19, 22, 25, 23, 3, 6, 28, 27, 9, 12, 15, 18, 21, 24, 2, 5, 8, 11, 14, 17, 20, 26]
